...
* [X] Used RxJava: 1) the M-V-VM event driven part is done using RxJava’s Observables and 2) Retrofil is used in conjunction with RxJava adapter for asynchronous network calls
...
## License
    ...
    Copyright [Elmira Andreeva] [name of copyright owner]
